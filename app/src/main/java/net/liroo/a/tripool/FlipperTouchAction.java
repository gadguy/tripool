...
public class FlipperTouchAction implements View.OnTouchListener
{
    private Context context;
    private int countIndexes;   // 전체 화면 개수
    private int currentIndex;   // 현재 화면 인덱스
    private float downX;    // 터치시작 x좌표
    private float upX;  // 터치끝 x좌표

    private ViewFlipper flipper;
    private ViewFlipperCallback indexCallback;  // 뷰 플리퍼 콜백 액션
    ...
    public FlipperTouchAction(Context context, ViewFlipper flipper)
    {
